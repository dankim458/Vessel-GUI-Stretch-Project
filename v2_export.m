function varargout = v2_export(varargin)
% V2_EXPORT MATLAB code for v2_export.fig
%      V2_EXPORT, by itself, creates a new V2_EXPORT or raises the existing
%      singleton*.
%
%      H = V2_EXPORT returns the handle to a new V2_EXPORT or the handle to
%      the existing singleton*.
%
%      V2_EXPORT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in V2_EXPORT.M with the given input arguments.
%
%      V2_EXPORT('Property','Value',...) creates a new V2_EXPORT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before v2_export_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to v2_export_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help v2_export

% Last Modified by GUIDE v2.5 06-Nov-2018 11:59:26

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @v2_export_OpeningFcn, ...
    'gui_OutputFcn',  @v2_export_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before v2_export is made visible.
function v2_export_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to v2_export (see VARARGIN)

% Choose default command line output for v2_export
...
% UIWAIT makes v2_export wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = v2_export_OutputFcn(hObject, eventdata, handles)
